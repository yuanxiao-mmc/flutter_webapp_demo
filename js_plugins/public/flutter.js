...
;(function () {
  ...
  class FlutterLoader {
    ...
    _loadWithServiceWorker(entrypointUrl, serviceWorkerOptions) {
      ...
      let serviceWorkerUrl = window.flutterSWPath + 'flutter_service_worker.js?v=' + serviceWorkerVersion
      let loader = navigator.serviceWorker.register(serviceWorkerUrl, { scope: '/' + window.flutterSWPath }).then((reg) => {
